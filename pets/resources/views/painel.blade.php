                ...
                <div class="col dropdown d-flex align-items-center justify-content-end">
                    ...
                    <ul class="dropdown-menu">
                        <li>
                            ...
                            <a class="dropdown-item text-end" href="{{ url('login') }}">
                                <small>Sair</small>
                            </a>
                        </li>
                    </ul>
    ...
    <div class="d-flex" style="min-height: calc(100vh - 76px - 72px);">
        <aside class="bg-custom text-light py-4" style="width: 250px;">
            <div class="menu">
                <div class="item">
                    ...
                    <div class="collapse show" id="menu-usuario">
                        <div class="bg-dark d-flex flex-column rounded mx-4 p-2 row-gap-1">
                            <a href="{{ url('cadastrar') }}" class="submenu-link link-light text-decoration-none rounded p-2">
                                <small class="d-flex justify-content-between align-items-center">
                                    Cadastrar
                                </small>
                            </a>
                            <a href="{{ url('painel') }}" class="submenu-link link-light text-decoration-none rounded p-2 active">
                                <small class="d-flex justify-content-between align-items-center">
                                    Listagem
                ...
                <a href="{{ url('login') }}" class="w-100 d-flex align-items-center gap-2 link-light text-decoration-none mt-2 py-3 px-3 ms-1 icon-link icon-link-hover" style="--bs-icon-link-transform: translate3d(-.125rem, 0, 0);">
        ...
        <main class="col h-100 text-light p-4">
            <div class="d-flex justify-content-between mb-4">
                ...
                <div class="d-flex gap-2">
                    ...
                    <a href="{{ url('cadastrar') }}" class="btn btn-light">+ Cadastrar Usuário</a>
                </div>
            </div>
                        ...
                        <tr>
                            ...
                            <td>
                                <div class="d-flex justify-content-center">
                                    ...
                                    <a href="{{ url('editar') }}" class="btn btn-light d-flex justify-content-center align-items-center rounded-circle p-2 mx-2" title="Editar">
